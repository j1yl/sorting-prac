...
void assertEquals(std::string testName, int expected[], int actual[], int n) {
...
void assertEquals(std::string testName, std::string expected,
                  std::string actual) {
  if (expected == actual) {
    cout << "PASSED: " << testName << endl;
    ;
...
void assertEquals(std::string testName, int expected, int actual) {
  if (expected == actual) {
    cout << "PASSED: " << testName << endl;
    ;
  } else {
